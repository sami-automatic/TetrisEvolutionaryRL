...
class TetrisEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self._action_set = self.game.getActionSet()
    ...
    def _step(self, a):
        ...
        reward = 0.0
        state, reward, terminal = self.game.step(self._action_set)
        return state, reward, terminal, {}

    def _get_image(self):
        return self.game.getImage()
    ...
    def _reset(self):
        ...
        do_nothing[0] = 1
        self.observation_space = spaces.Box(low=0, high=255, shape=(SCREEN_HEIGHT, SCREEN_WIDTH, 3))
        state, _, _= self.game.step(do_nothing)
        return state
